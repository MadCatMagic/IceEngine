...
public:
	...
	inline virtual void SetBorderColour(const Vector4& colour) const {};

	inline void BindTextureUnit(unsigned int unit) const { glActiveTexture(GL_TEXTURE0 + unit); }
	inline void UnbindTextureUnit() const { glActiveTexture(GL_TEXTURE0); }
